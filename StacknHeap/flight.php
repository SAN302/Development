...
<div class="container text-center">    
  <div class="row">
      <div class="col-lg-12">
<a class="navbar-brand"  href="flight_form.php">Add Flight</a>
<br>
...
<!--<div id="id01" class="modal">
  ...
  <div class="container">
   ...
   <a href="flight.php"><input type="button" name="button" value="Login"></a>
	...
	<?php
		$temp_id=$_SESSION['id'];
		$query = mysqli_query($conn,"SELECT source,destination,flight_date,weight,status FROM flight WHERE user_id='$temp_id'");
